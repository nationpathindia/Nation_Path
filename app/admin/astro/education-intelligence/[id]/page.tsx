...
// Education Intelligence View Page
//////////////////////////////////////////////////////////////
...
export default function EducationViewPage(){
  ...
  const remove = async()=>{
    ...
    const ok = confirm(
      ...
      "Delete this Education Intelligence?"
...
`/admin/astro/education-intelligence/${id}/edit`
...
<Section title="Education Knowledge">
...
value={data.educationStrengths?.join(", ")}
...
value={data.academicChallenges?.join(", ")}
