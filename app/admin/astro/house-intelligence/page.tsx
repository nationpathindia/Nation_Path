...
export default function HouseIntelligencePage(){
...
Astrological House Knowledge Management
...
href="/admin/astro/house-intelligence/create"
...
href={`/admin/astro/house-intelligence/${item._id}`}
...
href={`/admin/astro/house-intelligence/${item._id}/edit`}
