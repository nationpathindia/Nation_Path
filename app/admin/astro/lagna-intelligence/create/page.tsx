...
export default function CreateLagnaPage(){
  ...
  const submit = async()=>{
    ...
    try{
      ...
      const payload = {
        ...
        convertArray(form.personalityTraits),
        ...
        convertArray(form.physicalTraits),
        ...
        convertArray(form.mentalTraits),
        ...
        convertArray(form.supportivePlanets),
        ...
        convertArray(form.challengingPlanets),
