...
export default function YogaIntelligencePage(){
...
Astrology Yoga Knowledge Management
...
href="/admin/astro/yoga-intelligence/create"
...
href={`/admin/astro/yoga-intelligence/${item._id}`}
...
href={`/admin/astro/yoga-intelligence/${item._id}/edit`}
