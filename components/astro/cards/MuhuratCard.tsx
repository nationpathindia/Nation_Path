...
interface MuhuratCardProps {
  ...
  timingBadge?: string; // Optional custom operational time state (e.g., "Shubh", "Choghadiya")
}
...
export default function MuhuratCard({
  ...
  return (
    ...
    >
      ...
      <div 
        aria-hidden="true" 
        className="absolute -right-24 -bottom-24 -z-10 h-52 w-52 rounded-full bg-[#C9A227]/5 blur-3xl pointer-events-none transition-opacity duration-500 group-hover:opacity-100" 
      />

      {/* Luxury Top Linear Accent */}
      <div
        aria-hidden="true"
        className="
          absolute
      ...
      <div className="relative flex flex-col h-full justify-between">
        <div>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            {/* Time-Sensitive Vitality Indicator */}
