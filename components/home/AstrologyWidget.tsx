  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        setPanchang(
          json?.data?.panchang || null,
        );

        setMuhurta(
          json?.data?.muhurta?.data || null,
        );
      } catch (error) {
        console.error(
          "Astro Widget Error",
  ...
  const auspicious = [
    {
      ...
      start:
        muhurta?.auspicious?.abhijit?.start,
      end:
        muhurta?.auspicious?.abhijit?.end,
    },
    {
      name: "Brahma Muhurat",
      start:
        muhurta?.auspicious?.brahma?.start,
      end:
        muhurta?.auspicious?.brahma?.end,
    },
    {
      name: "Amrit Kaal",
      start:
        muhurta?.auspicious?.amritKaal?.[0]
          ?.start,
      end:
        muhurta?.auspicious?.amritKaal?.[0]
          ?.end,
  ...
  const avoid = [
    {
      name: "Rahu Kaal",
      start:
        muhurta?.inauspicious?.rahu?.start,
      end:
        muhurta?.inauspicious?.rahu?.end,
    },
    {
      name: "Gulika Kaal",
      start:
        muhurta?.inauspicious?.gulika?.start,
      end:
        muhurta?.inauspicious?.gulika?.end,
    },
  ];
